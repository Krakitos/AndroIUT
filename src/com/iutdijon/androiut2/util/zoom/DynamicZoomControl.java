...
import com.iutdijon.androiut2.util.zoom.util.SpringDynamics;
...
public class DynamicZoomControl implements Observer {
    ...
    public void pan(float dx, float dy) {
        ...
        final double newPanX = mState.getPanX() + dx;
        final double newPanY = mState.getPanY() + dy;
     ...
     * 
     * @param zoomY Zoom value
     * @return Max delta of pan
     */
    private double getMaxPanDelta(double zoomY) {
        return Math.max(0f, .5f * ((zoomY - 1) / zoomY));
    }
