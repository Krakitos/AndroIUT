 ...
 * Checking if mBitmap is null on onLayout()
 */
package com.iutdijon.androiut2.util.view;
...
import com.iutdijon.androiut2.util.zoom.AspectQuotient;
import com.iutdijon.androiut2.util.zoom.ZoomState;
...
public class ImageZoomView extends View implements Observer{
    ...
    protected void onDraw(Canvas canvas) {
        if (mBitmap != null && mState != null) {
            ...
            final double panX = mState.getPanX();
            final double panY = mState.getPanY();
